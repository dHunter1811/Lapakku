...
<style>
    ...
    .edit-lahan-form .form-control,
    .edit-lahan-form .form-select {
    ...
    .edit-lahan-form .form-control:focus,
    .edit-lahan-form .form-select:focus {
        border-color: #3b82f6;
        box-shadow: 0 0 0 0.2rem rgba(59, 130, 246, 0.25);
    }

    .edit-lahan-form .form-group {
        margin-bottom: 1.5rem;
    }

    .map-search-container-edit {
        display: flex;
        gap: 10px;
        margin-bottom: 10px;
    }

    .map-search-container-edit input[type="text"] {
        flex-grow: 1;
    }
    ...
    .galeri-edit-item .form-label-sm {
        font-size: 0.85em;
        display: block;
    ...
    .galeri-edit-item .current-image-display img {
        max-width: 100px;
        max-height: 75px;
    }
    ...
    <div class="card" style="max-width: 750px; margin: 30px auto; padding: 30px 35px;">
        ...
        <form action="{{ route('lahan.update', $lahan->id) }}" method="POST" enctype="multipart/form-data" class="edit-lahan-form">
            ...
            <div class="form-group">
                ...
                <input type="tel" name="no_whatsapp" id="no_whatsapp" class="form-control" value="{{ old('no_whatsapp', $lahan->no_whatsapp) }}" placeholder="Contoh: 081234567890 (awali dengan 0)">
