    ...
    <style>
        ...
        *::after {
        ...
        .header-nav {
            ...
            color: white;
            padding: 10px 0;
            /* Mungkin perlu sedikit ditambah jika logo besar */
            ...
            <nav class="main-nav" style="display: flex; align-items: center;">
                ...
                <div class="user-profile-dropdown" id="userProfileDropdown">
                    ...
                    <div class="user-profile-dropdown-content">
                        ...
                        @else
                        <a href="{{ route('lahanbaru.tambah') }}"><span class="icon">➕</span>Tambah Lahan Baru</a>
